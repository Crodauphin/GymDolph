/* ═══════════════════════════════════════════
   GYM DOLPH v0.3 — PROGRAM DATA
   FitPlace24 Sapporo — 7-Day Split
   Health notes: spondylolisthesis (lower back) + left shoulder
═══════════════════════════════════════════ */
    ...
    blocks: [
      {
        ...
        exercises: [
          ...
          { id: 'w3', name: 'Band Pull-Apart / Arm Circles', prescription: '2 × 15 reps', sets: 2, reps: 15, note: 'Shoulder activation — gentle on left' },
        ]
      },
      {
    ...
    blocks: [
      {
        ...
        exercises: [
          ...
          { id: 'w2', name: 'Cat-Cow Back Mobility', prescription: '2 × 10 reps', sets: 2, reps: 10, note: 'Bodyweight — keep range small, no deep arch' },
          { id: 'w3', name: 'Band Face Pulls / Shoulder Rotations', prescription: '2 × 15 reps', sets: 2, reps: 15, note: 'Activation — gentle on left shoulder' },
        ]
      },
      {
      ...
      {
        id: 'secondary', type: 'secondary', title: 'SECONDARY — BICEPS', icon: '💪', duration: '15 min',
        exercises: [
          ...
          { id: 's4', name: 'Assisted Chin-Up (Narrow grip)', prescription: '3 × 8 reps', sets: 3, reps: 8, note: 'Assisted Chin-Up machine — palms facing you' },
        ]
      },
      {
        id: 'cardio', type: 'cardio', title: 'CARDIO', icon: '🏃', duration: '20 min',
    ...
    blocks: [
      {
        ...
        exercises: [
          ...
          { id: 'w2', name: 'Leg Swings & Hip Circles', prescription: '2 × 10 each direction', sets: 2, reps: 10, note: 'Hold rail for balance' },
          { id: 'w3', name: 'Ankle Rolls + Calf Raises', prescription: '2 × 10 each', sets: 2, reps: 10, note: 'Warm up lower legs' },
        ]
      },
      {
      ...
      {
        id: 'secondary', type: 'secondary', title: 'SECONDARY — GLUTES', icon: '🍑', duration: '15 min',
        exercises: [
    ...
    blocks: [
      {
        ...
        exercises: [
          ...
          { id: 'w2', name: 'Shoulder CARs (Controlled Articular Rotations)', prescription: '2 × 5 each direction', sets: 2, reps: 5, note: 'Gentle full ROM — extra care on left shoulder' },
          { id: 'w3', name: 'Band Lateral Raises', prescription: '2 × 15 reps', sets: 2, reps: 15, note: 'Light band — activation only' },
        ]
      },
      {
        ...
        exercises: [
          ...
          { id: 'm2', name: 'Standing Lateral Raise Machine', prescription: '4 × 15 reps', sets: 4, reps: 15, note: 'Standing Lateral Rays/Frys machine — light on left side' },
          { id: 'm3', name: 'Rear Delt Fly (Pec Fly Machine)', prescription: '3 × 15 reps', sets: 3, reps: 15, note: 'Peck Fry/Rear Delto — use rear delt function' },
      ...
      {
        id: 'secondary', type: 'secondary', title: 'SECONDARY — ABS & CORE', icon: '⚡', duration: '15 min',
        exercises: [
          ...
          { id: 's3', name: 'Leg Raise (Station)', prescription: '3 × 15 reps', sets: 3, reps: 15, note: 'Chin/Dip/Leg Raise Station — lower abs' },
          { id: 's4', name: 'Back Extension (Bodyweight only)', prescription: '3 × 15 reps', sets: 3, reps: 15, note: 'Back extension bench — no added weight, slow controlled' },
        ]
      },
      {
        id: 'cardio', type: 'cardio', title: 'CARDIO', icon: '🏃', duration: '20 min',
    ...
    blocks: [
      {
        ...
        exercises: [
          { id: 'w1', name: 'Recumbent Bike', prescription: '5 min · very easy pace', sets: 1, reps: 1, note: 'Zero spinal load · great warm-up for spondylolisthesis' },
          { id: 'w2', name: 'Leg Swings (front/back + lateral)', prescription: '10 reps each direction · each leg', sets: 1, reps: 10, note: 'Standing · hold rail for balance' },
      ...
      },
      {
        ...
        exercises: [
          { id: 'cA', name: 'Recumbent Bike Intervals', prescription: '15 min · 2 min easy warm-in · 1 min hard / 1 min easy ×5 · 3 min easy cool-out', sets: 1, reps: 1, note: 'Zero spinal compression · increase resistance on hard efforts · stay seated' },
        ]
      },
      {
        id: 'blockB', type: 'cardio', title: 'BLOCK B · CROSS TRAINER', icon: '🏃', duration: '15 min',
        exercises: [
          { id: 'cB', name: 'Cross Trainer Steady-State', prescription: '15 min · moderate effort (6–7 RPE) · arms active · upright posture', sets: 1, reps: 1, note: 'Low impact on lower back · choose resistance that keeps you moving fluidly' },
        ]
      },
      {
        id: 'blockC', type: 'cardio', title: 'BLOCK C · UPRIGHT BIKE', icon: '🚵', duration: '20 min',
        exercises: [
          { id: 'cC', name: 'Upright Bike Pyramid', prescription: '20 min · pyramid 1→2→3→2→1 min hard · 1 min easy between each effort', sets: 1, reps: 1, note: 'Resistance up 2 notches on hard efforts · stay seated throughout · controlled breathing' },
        ]
      },
      {
        id: 'cooldown', type: 'warmup', title: 'COOL DOWN', icon: '❄️', duration: '5 min',
        exercises: [
          { id: 'cd1', name: 'Recumbent Bike', prescription: '5 min · low resistance · 4–5 km/h', sets: 1, reps: 1, note: 'Let HR drop naturally · back supported throughout' },
        ]
      }
    ]
  },
    ...
    stretchPhases: [
      {
        ...
        moves: [
          { id: 'p1a', name: 'Diaphragmatic Breathing', detail: '3 min · seated · 4s inhale, hold 2s, 6s exhale', note: 'Activate parasympathetic system before stretching' },
          { id: 'p1b', name: 'Neck Rolls', detail: '5 slow rolls each direction · ear to shoulder pauses', note: 'Never roll full circle backward' },
          { id: 'p1c', name: 'Seated Torso Rotations', detail: '10 reps each side · hands on thighs', note: 'Gentle spinal mobilisation' },
          { id: 'p1d', name: 'Seated Side Reach', detail: '8 reps each side · arm overhead, lean away · hold 3s each', note: '' },
        ]
      },
      {
        icon: '🦵', title: 'LOWER BODY', duration: '20 min',
        moves: [
          { id: 'p2a', name: 'Standing Hip Flexor Stretch', detail: '45s each side · step forward, rear leg straight · hold wall for balance', note: '⚠ Crucial for spondylolisthesis — tight flexors increase lumbar load' },
          { id: 'p2b', name: 'Pigeon Pose (Chair Modified)', detail: '60s each side · seated, ankle on opposite knee, hinge forward', note: 'No mat needed — same benefit as floor pigeon' },
          { id: 'p2c', name: 'Standing Quad Stretch', detail: '45s each side · hold wall or chair · knees together', note: '' },
          { id: 'p2d', name: 'Standing Hamstring Stretch', detail: '45s each side · leg on chair, slight forward hinge, back flat', note: '⚠ Never round the lower back' },
          { id: 'p2e', name: 'Seated Calf Stretch', detail: '45s each side · foot on floor, lean forward slightly', note: '' },
          { id: 'p2f', name: 'IT Band Stretch (Standing)', detail: '45s each side · cross one foot behind, lean away from front foot', note: '' },
      ...
      },
      {
        ...
        moves: [
          { id: 'p3a', name: 'Cross-Body Shoulder Stretch', detail: '45s each arm · arm at chest height', note: '⚠ Gentle on left shoulder' },
          { id: 'p3b', name: 'Doorframe Chest Stretch', detail: '45s · forearms on door frame, step through', note: 'Or interlace hands behind back instead' },
          { id: 'p3c', name: 'Overhead Tricep Stretch', detail: '45s each arm · arm up, bend elbow, pull gently', note: '⚠ Left side — stop if shoulder pinches' },
          { id: 'p3d', name: 'Wrist & Forearm Stretch', detail: '30s each position · palm up, palm down, fingers back', note: '' },
          { id: 'p3e', name: 'Thread the Needle (Standing)', detail: '5 reps each side · slide one arm under opposite arm along wall', note: 'Upper thoracic rotation — back-friendly' },
        ]
      },
      {
        icon: '🧘', title: 'BACK & SPINE', duration: '10 min',
        moves: [
          { id: 'p4a', name: 'Standing Cat-Cow (Wall)', detail: '10 reps · hands on wall, alternate arch and round', note: '⚠ Keep range small — no deep arch' },
          { id: 'p4b', name: 'Supported Back Extension (Chair)', detail: '8 reps · hands on lower back, gentle extension', note: '⚠ Stop if any nerve pain down legs' },
          { id: 'p4c', name: 'Seated Spinal Twist', detail: '60s each side · sitting tall, hand on outside of opposite knee', note: '' },
          { id: 'p4d', name: 'Standing Glute Stretch (Wall Sit)', detail: '45s each side · cross ankle over knee, sit into wall', note: 'Wall-sit style — no floor needed' },
        ]
      },
      {
        icon: '☮️', title: 'CLOSING', duration: '5 min',
        moves: [
          { id: 'p5a', name: 'Standing Forward Fold (Supported)', detail: '2 min · hang from hips, slight bend in knees, arms dangle', note: 'Great spinal decompression — gravity does the work' },
          { id: 'p5b', name: 'Closing Breathing', detail: '3 min · seated · 4s inhale, 8s exhale · let body fully relax', note: '' },
        ]
      }
    ]
  },
...
/* ═══════════════════════════════════════════
   EXERCISE INFO LIBRARY
   Each key matches exercise name (lowercase, trimmed)
   muscles: primary targets
   cues: 3-4 form bullet points
   note: health/safety flag
...
const EX_INFO = {
  'bench press': {
    ...
    note: null,
    yt: 'bench press proper form tutorial'
  },
  'incline chest press (plate load)': {
    ...
    note: '⚠ Left shoulder: reduce ROM if any pinch',
    yt: 'incline chest press machine form'
  },
  'pec fly / rear delt machine': {
    ...
    note: null,
    yt: 'pec deck fly rear delt machine form'
  },
  'cable crossover (compact)': {
    ...
    note: null,
    yt: 'cable crossover low to high chest form'
  },
  'seated dip machine': {
    ...
    note: '⚠ Left shoulder: if any pinch, reduce range',
    yt: 'seated dip machine triceps form'
  },
  'cable tricep pushdown': {
    ...
    note: null,
    yt: 'cable tricep pushdown form tutorial'
  },
  'overhead tricep extension (cable)': {
    ...
    note: '⚠ Left shoulder: stop if overhead position causes pain',
    yt: 'overhead cable tricep extension form'
  },
  'bag extension machine': {
    ...
    note: null,
    yt: 'tricep extension machine form'
  },
  'barbell row (smith machine)': {
    ...
    note: '⚠ Spondylolisthesis: neutral spine is critical — no rounding',
    yt: 'smith machine barbell row form'
  },
  'lat pull-down (cable)': {
  ...
  'low row machine': {
    ...
    note: null,
    yt: 'seated low row machine form'
  },
  't-bar row (plate load)': {
    ...
    note: '⚠ Spondylolisthesis: prefer chest-supported version',
    yt: 't-bar row chest supported form'
  },
  'high row (plate load)': {
    ...
    note: null,
    yt: 'high row machine form tutorial'
  },
  'barbell curl (curl bench)': {
    ...
    note: null,
    yt: 'barbell curl strict form tutorial'
  },
  'bicep curl machine (bicepsal)': {
  ...
  'assisted chin-up (narrow grip)': {
    ...
    note: null,
    yt: 'assisted chin up form tutorial'
  },
  'barbell squat (power rack)': {
    ...
    note: '⚠ Spondylolisthesis: brace hard, avoid butt wink (pelvis tuck at bottom)',
    yt: 'barbell squat proper form spondylolisthesis safe'
  },
  'hack squat machine': {
    ...
    note: null,
    yt: 'hack squat machine form tutorial'
  },
  'seated leg press': {
    ...
    note: '⚠ Spondylolisthesis: keep lower back flat on pad — never let it peel off',
    yt: 'seated leg press form lower back safe'
  },
  ...
  'hip thrust machine': {
    ...
    note: '⚠ Spondylolisthesis: stop at neutral hip — no hyperextension',
  ...
  'link hip abduction': {
    ...
    note: null,
    yt: 'cable hip abduction machine form'
  },
  'seated calf raise': {
  ...
  'shoulder press machine': {
    ...
    note: '⚠ Left shoulder: use machine over free bar for safer path',
  ...
  'standing lateral raise machine': {
    ...
    note: '⚠ Left shoulder: reduce weight, stop if any pain',
    yt: 'lateral raise machine form medial deltoid'
  },
  ...
  'dumbbell lateral raises': {
    ...
    note: '⚠ Left shoulder: very light weight, stop at first sign of pain',
    yt: 'dumbbell lateral raise perfect form'
  },
  'abdominal machine (crunch)': {
    ...
    note: '⚠ Spondylolisthesis: machine guides ROM safely — avoid hip flexor dominance',
  ...
  'rotary torso machine': {
    ...
    note: '⚠ Spondylolisthesis: machine-guided rotation is safest — never twist aggressively',
  ...
  'leg raise (station)': {
    ...
    note: '⚠ Spondylolisthesis: if lower back arches excessively, bend knees instead',
    yt: 'hanging leg raise form lower abs'
  },
  'back extension (bodyweight only)': {
    ...
    note: '⚠ Spondylolisthesis: STOP at neutral position — no extension beyond straight',
    yt: 'back extension machine safe form lower back'
  },
  'smith machine goblet squat': {
    muscles: 'Quadriceps · Glutes · Core',
    cues: ['Bar at chest height, elbows under bar', 'Sit back and down — upright torso', 'Knees track over toes', 'Smith keeps load guided for spine safety'],
    note: '⚠ Spondylolisthesis: preferred over free squat — controlled spine loading',
    yt: 'smith machine goblet squat form'
  },
  'recumbent bike': {
    ...
    note: null,
    yt: 'recumbent bike proper form cardio'
  },
  'cross trainer': {
    ...
    note: null,
    yt: 'elliptical cross trainer proper form'
  },
  'upright bike': {
    ...
    note: null,
    yt: 'upright exercise bike proper form'
  },
};
