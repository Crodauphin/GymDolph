...
window.USER_PROFILE = {
  ...
  goals: {
    ...
    physique:        'Functional hybrid — trail runner / alpine athlete build. Not bulk.',
    performance:     'Hiking, mountaineering, cycling endurance, trail running',
  },

  workingWeights: [
    { movement: 'Barbell bench press (flat)',    weight: '50-55kg total',      note: 'Feel out rack position first session' },
    ...
    { movement: 'Barbell RDL',                   weight: 'Start light',        note: 'PT session before loading' },
    { movement: 'Leg press',                     weight: '80-90kg',            note: '' },
    { movement: 'Glute machine hip thrust',      weight: '40kg',               note: 'From Sapporo baseline' },
    { movement: 'Prone leg curl',                weight: '35kg',               note: '' },
    { movement: 'Dumbbell shoulder press',       weight: '10-12kg DBs',        note: 'Conservative — shoulder constraint' },
    { movement: 'Hammer curl — dumbbells',       weight: '10kg',               note: '3 x 8' },
  ],
...
- No axial loading: no barbell back squats, conventional barbell deadlifts, good mornings
...
- Barbell RDL (hip hinge pattern)
- Barbell bent-over row (lumbar bracing)
