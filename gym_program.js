      ...
      blocks: [
        ...
        { id: 'main', type: 'main', title: 'Main — Legs + Glutes', duration: '50 min',
          exercises: [
            ...
            { id: 'm4', name: 'Abductor / adductor machine', prescription: '3 x 12 each', sets: 3, reps: 12, weight: 'Moderate',
            ...
            { id: 'm5', name: 'Glute machine hip thrust', prescription: '3 x 10', sets: 3, reps: 10, weight: '40kg',
      ...
      blocks: [
        { id: 'main', type: 'main', title: 'Mobility',
          exercises: [
            ...
            { id: 's2', name: 'Hip flexor stretch — couch stretch', prescription: '2 min each side', sets: 1, reps: 1, note: '2 min each side', bodyweight: true,
            ...
            { id: 's3', name: 'Pigeon pose', prescription: '2 min each side', sets: 1, reps: 1, note: '2 min each side', bodyweight: true,
            ...
            { id: 's4', name: 'Cat / cow', prescription: '1 x 10', sets: 1, reps: 10, bodyweight: true,
            ...
            { id: 's5', name: 'Thread the needle — thoracic rotation', prescription: '1 x 8', sets: 1, reps: 8, bodyweight: true,
            ...
            { id: 's6', name: 'Open book shoulder stretch', prescription: '1 x 8', sets: 1, reps: 8, bodyweight: true,
            ...
            { id: 's7', name: '90/90 hip mobility', prescription: '2 min each side', sets: 1, reps: 1, note: '2 min each side', bodyweight: true,
            ...
            { id: 's8', name: 'Neck + upper trap release', prescription: '2 min each side', sets: 1, reps: 1, note: '2 min each side', bodyweight: true,
            ...
            { id: 's9', name: 'Pec mobilisation — spiky ball', prescription: '60s each side', sets: 1, reps: 1, note: '60s each side', bodyweight: true,
