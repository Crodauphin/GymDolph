...
//   - Milestones: weekly volume milestone added (performance ladder); 'crushing it' milestone added
...
window.PROGRAM = {
  ...
  milestones: {
    ...
    performance: [
      { target: '35kg assist x 5 reps x 3 (current)', timeline: 'Now',       metric: 'Pull-ups' },
      ...
      { target: '4 gym days + Active Day logged',      timeline: 'Weekly',    metric: 'Volume',   icon: '🔥' },
      { target: '4 gym days + Active Day + Yoga all logged', timeline: 'Weekly', metric: 'Crushing it', icon: '🏆' }
    ],
    bodycomp: [
      { target: '6.7 -> 7.5+ degrees', timeline: '3-6 months', metric: 'Phase angle', auto: { field: 'phase', min: 7.5 } },
      { target: '92.3kg -> ~85kg',      timeline: '6 months',   metric: 'Body weight',  auto: { field: 'weight', max: 86 } },
      ...
      blocks: [
        ...
        { id: 'main', type: 'main', bodyPart: 'Back', duration: '40 min',
          exercises: [
            ...
            { id: 'm4', name: 'Assisted pull-up', prescription: '3 x 5', sets: 3, reps: 5, weight: '25kg assist',
    ...
    // ── D6 · Sat · Active Day ───────────────────────────────────────────────
    {
      ...
      activities: [
        ...
        { id: 'walk',      label: 'Walk',             icon: '🚶',
          note: 'Darebin Trail Walk: long 8.5km ~1h45 / short 5km ~1h — log presets coming in next update' },
