...
window.PROGRAM = {
  ...
  milestones: {
    // v0.9.9: startDate anchors the relative "In X months/weeks" countdown shown on
    // each milestone card — set to the Technogym body-composition baseline (Jul 4, 2026).
    startDate: '2026-07-04',
    // Renamed from 'pullup' -> 'performance': the key is generic (any tracked skill/
    // performance goal), not pull-up-specific — currently pull-ups for Albin, but this
    // could change. Every step sets its own `metric` explicitly (the ladder no longer
    // has a hardcoded fallback label), so this stays correct if the tracked skill changes.
    performance: [
      { target: '35kg assist x 5 reps x 3',        timeline: 'Now',          metric: 'Pull-ups' },
      { target: 'Reduce assist to 20kg',             timeline: 'Weeks ahead', metric: 'Pull-ups' },
      { target: 'First unassisted attempt',          timeline: 'Week 6',      metric: 'Pull-ups' },
  ...
  days: [
    ...
    // ── D1 · Mon · Chest + Triceps ──────────────────────────────────────────
    {
      ...
      blocks: [
        { id: 'warmup', type: 'warmup', title: 'Warm-up', bodyPart: '', duration: '10 min',
          exercises: [
        ...
        { id: 'main', type: 'main', title: 'Main — Chest', bodyPart: 'Chest', duration: '40 min',
          exercises: [
        ...
        { id: 'secondary', type: 'secondary', title: 'Secondary — Triceps', bodyPart: 'Triceps', duration: '20 min',
          exercises: [
    ...
    // ── D2 · Tue · Back + Biceps ────────────────────────────────────────────
    {
      ...
      blocks: [
        ...
        { id: 'main', type: 'main', title: 'Main — Back', bodyPart: 'Back', duration: '40 min',
          exercises: [
        ...
        { id: 'secondary', type: 'secondary', title: 'Secondary — Biceps', bodyPart: 'Biceps', duration: '20 min',
          exercises: [
    ...
    // ── D4 · Thu · Shoulders + Core ─────────────────────────────────────────
    {
      ...
      blocks: [
        { id: 'warmup', type: 'warmup', title: 'Physio warm-up', bodyPart: '', note: 'Do not skip', duration: '10 min',
          exercises: [
            { id: 'w1', name: 'Prone scapula retractions', prescription: '3 x 12', sets: 3, reps: 12, bodyweight: true,
              muscles: 'mid-traps, rhomboids',
        ...
        { id: 'main', type: 'main', title: 'Main — Shoulders', bodyPart: 'Shoulders', duration: '25 min',
          restSeconds: 90,
          exercises: [
        ...
        { id: 'secondary', type: 'secondary', title: 'Secondary — Core', bodyPart: 'Core', duration: '25 min',
          exercises: [
    ...
    // ── D5 · Fri · Yoga / Mobility ──────────────────────────────────────────
    {
      ...
      blocks: [
        { id: 'main', type: 'main', title: 'Mobility', bodyPart: '', typeLabel: 'Mobility', icon: '🧘',
          logType: 'session',
          exercises: [
            { id: 'yoga', name: 'Yoga', prescription: 'Log duration + style',
