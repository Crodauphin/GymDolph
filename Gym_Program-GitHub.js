    ...
    // ── D1 · Mon · Chest + Triceps ──────────────────────────────────────────
    {
      ...
      blocks: [
        { id: 'warmup', type: 'warmup', bodyPart: '', duration: '10 min',
          exercises: [
            { id: 'w1', name: 'Shoulder Big 3', sets: 1, reps: 20, each: 'position', weight: '1kg each hand', bodyweight: false,
            ...
            { id: 'w2', name: 'Face pull — cable rope', sets: 3, reps: 12, weight: '12kg', restSeconds: 30,
            ...
            { id: 'w3', name: 'GHjt external rotation', sets: 2, reps: 10, weight: '5kg', restSeconds: 30,
            ...
            { id: 'w4', name: 'Seated shoulder external rotation', sets: 3, reps: 10, weight: '0.1-1kg DB — maximum 5kg', restSeconds: 30,
        ...
        { id: 'main', type: 'main', bodyPart: 'Chest', duration: '40 min',
          exercises: [
            { id: 'm1', name: 'Barbell bench press (flat)', sets: 4, reps: 4, weight: '60kg (incl 20kg bar)', pt: true,
            ...
            { id: 'm2', name: 'Incline dumbbell press', sets: 3, reps: 6, weight: '20kg DBs',
            ...
            { id: 'm3', name: 'Cable chest fly', sets: 3, reps: 10, weight: '15kg each side',
        ...
        { id: 'secondary', type: 'secondary', bodyPart: 'Triceps', duration: '20 min',
          exercises: [
            ...
            { id: 's3', name: 'Skull crusher', sets: 3, reps: 8, weight: '20kg bar',
    ...
    // ── D2 · Tue · Back + Biceps ────────────────────────────────────────────
    {
      ...
      blocks: [
        { id: 'warmup', type: 'warmup', bodyPart: '', duration: '10 min',
          exercises: [
            ...
            { id: 'w2', name: 'Face pull — cable rope', sets: 3, reps: 12, weight: '12kg', restSeconds: 30,
              ...
              cues: ['Rope attachment at chest height', 'Pull to forehead, elbows high and wide', '4 second hold at peak', 'Do not let lower back arch'],
              yt: 'face pull cable rope technique' },
            { id: 'w4', name: 'GHjt external rotation', sets: 2, reps: 10, weight: '5kg', restSeconds: 30,
              muscles: 'rotator cuff (infraspinatus, teres minor)',
        ...
        { id: 'main', type: 'main', bodyPart: 'Back', duration: '40 min',
          exercises: [
            { id: 'm1', name: 'Lat pulldown — cable', sets: 4, reps: 4, weight: '40-45kg', pt: true,
            ...
            { id: 'm4', name: 'Eccentric pull-up — neutral grip', sets: 3, reps: 2, weight: 'Bodyweight', bodyweight: true, holdSeconds: true, restSeconds: 90,
              note: 'Step up on box/bench to top position. Lower as slowly as possible. Log total lowering seconds for the set (2 reps x 10s = 20s). Progress: 2x15s, then 1x30s.',
              muscles: 'lats, biceps, core, scapula stabilisers',
              cues: ['Log total seconds under tension for the set, not per rep — 2 reps x 10s lowering = 20s', 'Neutral grip — palms facing each other', 'Step up to top position on box or bench', 'Lower as slowly as possible — 10 seconds minimum per rep', 'Full control throughout — do not drop', 'Progress by increasing lowering time: 2x15s then 1x30s'],
              yt: 'eccentric pull-up neutral grip technique' },
            { id: 'm2', name: 'Seated cable row (low row)', sets: 3, reps: 8, weight: '35kg',
            ...
            { id: 'm3', name: 'Single-arm dumbbell row', sets: 3, reps: 6, weight: '22kg', pt: true,
        ...
        { id: 'secondary', type: 'secondary', bodyPart: 'Biceps', duration: '20 min',
          exercises: [
            { id: 's2', name: 'Hammer curl — dumbbells', sets: 3, reps: 8, weight: '10-12kg DBs',
    ...
    // ── D3 · Wed · Legs + Glutes ────────────────────────────────────────────
    {
      ...
      blocks: [
        ...
        { id: 'main', type: 'main', bodyPart: 'Legs', duration: '40 min',
          exercises: [
            { id: 'm1', name: 'Leg press', sets: 4, reps: 4, weight: '90-110kg', pt: true,
            ...
            { id: 'm2', name: 'Hack squat', sets: 4, reps: 4, weight: '50kg', pt: true,
              muscles: 'quads, glutes, hamstrings',
            ...
            { id: 'm3', name: 'Leg extension machine', sets: 3, reps: 8, weight: '40kg',
            ...
            { id: 'm4', name: 'Leg curl machine', sets: 3, reps: 8, weight: '35kg',
              muscles: 'hamstrings',
        ...
        { id: 'secondary', type: 'secondary', bodyPart: 'Glutes', duration: '20 min',
          exercises: [
            { id: 's1', name: 'Hip abduction machine', sets: 3, reps: 12, weight: '35kg',
            ...
            { id: 's4', name: 'Hip adduction machine', sets: 3, reps: 12, weight: '30kg',
            ...
            { id: 's2', name: 'Glute machine hip thrust', sets: 3, reps: 10, weight: '20kg',
      ...
      blocks: [
        { id: 'warmup', type: 'warmup', bodyPart: '', duration: '15 min',
          ...
          exercises: [
            ...
            { id: 'w4', name: 'GHjt external rotation', sets: 2, reps: 8, weight: '5kg', restSeconds: 30,
              muscles: 'rotator cuff (infraspinatus)',
              cues: ['Elbow pinned to side at 90 degrees', 'Small controlled range, very light', 'Slow on the return'],
              yt: 'cable GHjt external rotation technique' },
            { id: 'w5', name: 'Seated shoulder external rotation', sets: 3, reps: 10, weight: '0.1-1kg DB — maximum 5kg', restSeconds: 30,
        ...
        { id: 'main', type: 'main', bodyPart: 'Shoulders', duration: '25 min',
          restSeconds: 90,
          exercises: [
            { id: 'm1', name: 'Dumbbell shoulder press (seated)', sets: 4, reps: 4, weight: '12kg DBs', pt: true, restSeconds: 90,
            ...
            { id: 'm2', name: 'Cable lateral raise — single arm', sets: 3, reps: 10, each: 'side', weight: '5-7kg',
            ...
            { id: 'm3', name: 'Cable woodchop — high to low', sets: 3, reps: 8, each: 'side', weight: '12kg each side',
        ...
        { id: 'secondary', type: 'secondary', bodyPart: 'Core', duration: '25 min',
          exercises: [
            { id: 'c1', name: 'Cable Pallof press', sets: 3, reps: 12, each: 'side', weight: '7-12kg each side',
